        ...
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="{{ url('admin/logout') }}"><img
            ...
            <ul>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{ asset('') }}assets/img/icons/product.svg"
                            alt="img"><span> Homepage</span> <span class="menu-arrow"></span></a>
                    <ul>
                        ...
                        <li><a href="subcategorylist.html">Achievment</a></li>
                        <li><a href="subaddcategory.html">Activities</a></li>
                        <li><a href="brandlist.html">Brand List</a></li>
                        <li><a href="addbrand.html">Contact Form</a></li>
